...
public String toString() {
	return "CountryStat [id=" + id + ", countryName=" + countryName + ", totalCases=" + totalCases + ", newCases="
			+ newCases + ", activeCases=" + activeCases + ", totalDeaths=" + totalDeaths + ", newDeaths=" + newDeaths
			+ ", totalRecovered=" + totalRecovered + ", seriousCritical=" + seriousCritical + ", region=" + region
			+ ", totalCasesPer1m=" + totalCasesPer1m + ", recordDate=" + recordDate + "]";
}
