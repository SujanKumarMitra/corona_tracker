...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<a class="navbar-brand"
			href="https://skm-corona-tracker.herokuapp.com/">COVID-19 Tracker</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<a class="nav-link" href="./india_stat.jsp">Stats of Indian
				States</a>
	...
	<div class="container" align="center">
		...
		<!-- live server url -->
		<h2>
			<a href="https://skm-corona-tracker.herokuapp.com/">Click here</a> to
			go to main page
		</h2>
