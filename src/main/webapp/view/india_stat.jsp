...
<%@page import="com.herokuapp.corona_tracker.controller.api.WebScrapper"%>
...
<%
	ArrayList<ArrayList<String>> tableData = (ArrayList<ArrayList<String>>) request.getAttribute("tableData");
	ArrayList<String> tableHeader = (ArrayList<String>) request.getAttribute("tableHeader");
...
<body>
	...
	<div class="container">
		<p class="text-center" style="font-size: 30px;">Details about
			Indian States and Territories</p>
		<p class="text-center" style="font-size: 25px;">
			Data fetched from <a href="https://www.mohfw.gov.in/">MOHFW</a> at
			<%=date %>
		</p>
