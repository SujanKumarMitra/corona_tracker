...
<%
	WorldStat worldStat = (WorldStat) request.getAttribute("worldStat");
	CaseByCountries caseByCountries = (CaseByCountries) request.getAttribute("caseByCountries");
...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<a class="nav-link" href="indiaStat">Stats of Indian States</a>
			<form class="form-inline my-2 my-lg-0" action="getCountryData"
				method="GET">
				<input class="form-control mr-sm-2" name="country_name"
					type="search" placeholder="Enter Country Name" aria-label="Search">
	...
	<div class="jumbotron">
		...
		<center>
			...
			<p class="lead">
				...
				<%=worldStat.getTotalCases() %></p>
			<p class="lead">
				TOTAL DEATHS:
				<%= worldStat.getTotalDeaths() %></p>
			<p class="lead">
				TOTAL RECOVERED:
				<%=worldStat.getTotalRecovered() %></p>
			<hr class="my-4">
			<p class="Lead">Enter Country Name to get Details about a
				specific country</p>
			<div style="top: 50%; left: 50%;">
				<form class="my-2 my-lg-0 sm" action="getCountryData" method="GET">
					<input style="width: auto;" class="form-control mr-sm-2"
						name="country_name" type="search" placeholder="Enter Country Name"
						aria-label="Search">
					<button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
				</form>
			</div>
			<p class="Lead">OR</p>
			<p class="Lead">
				<a href="indiaStat">Click Here</a> to See Stats of Indian
				States
			</p>
		</center>
	</div>
	<div class="container mx-auto">
		<p class="text-center" style="font-size: 30px;">Country Wise
			Stats:</p>
		<p class="text-center" style="font-size: 20px;">
			Data Refreshed On
			<%=caseByCountries.getStatisticTakenAt() %></p>
